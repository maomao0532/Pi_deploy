...
class RobotPaiHWLoop {  // NOLINT(cppcoreguidelines-special-member-functions)
 ...
 public:
   ...
   */
  RobotPaiHWLoop(ros::NodeHandle& nh, std::shared_ptr<RobotPaiHW> hardware_interface);
  ...
  **/
  ...
  std::shared_ptr<RobotPaiHW> hardwareInterface_;
};
